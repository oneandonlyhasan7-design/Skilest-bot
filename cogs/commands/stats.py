...
class Stats(commands.Cog):
    ...
    inline=False
        ...
        embed.set_footer(text="Powered by skilest devolopement™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def system_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                system_embed.set_footer(text="Powered by skilest devolopement™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def ping_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                ping_embed.set_footer(text="Powered by skilest devolopement™", icon_url=self.bot.user.display_avatar.url)
        ...
        async def team_button_callback(interaction):
            if interaction.user == ctx.author:
                ...
                team_embed.add_field(name="**<:olympus_team:1243399230651895809> Team(s)**", value="> **[skilest devolopement™](https://discord.gg/odx)**", inline=False)
                ...
                team_embed.set_footer(text="Powered by skilest devolopement™", icon_url=self.bot.user.display_avatar.url)
